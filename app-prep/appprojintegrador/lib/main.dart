...
import 'package:appprojintegrador/tela02.dart';
import 'package:appprojintegrador/tela03.dart';
import 'package:appprojintegrador/tela04.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          _DashboardButton(
              icon: Icons.smart_toy_outlined, label: 'Chatbot', onTap: () {Navigator.push(context,
